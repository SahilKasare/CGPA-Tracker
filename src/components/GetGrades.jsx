...
const GetGrades = () => {
  ...
  return (
    <div className="p-4 sm:p-10 bg-gray-100 min-h-screen flex items-center justify-center">
      <button
      ...
      <div className="relative max-w-md w-full bg-white shadow-lg p-4 sm:p-6 rounded-lg">
        <h1 className="text-2xl sm:text-3xl font-bold mb-6 text-center">Display Grades</h1>
        <div className="mb-4">
